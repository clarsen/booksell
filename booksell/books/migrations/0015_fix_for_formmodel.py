...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.solddate'
        # (to signature: django.db.models.fields.DateTimeField(null=True, blank=True))
        db.alter_column('books_book', 'solddate', orm['books.book:solddate'])
        
        # Changing field 'Book.location'
        # (to signature: django.db.models.fields.CharField(max_length=255, null=True, blank=True))
        db.alter_column('books_book', 'location', orm['books.book:location'])
