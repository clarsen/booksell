...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Condition.tags'
        db.add_column('books_condition', 'tags', orm['books.condition:tags'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Condition.tags'
        db.delete_column('books_condition', 'tags')
