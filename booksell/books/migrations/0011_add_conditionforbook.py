...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ConditionForBook'
        db.create_table('books_conditionforbook', (
            ('id', orm['books.conditionforbook:id']),
            ('book', orm['books.conditionforbook:book']),
            ('condition', orm['books.conditionforbook:condition']),
            ('order', orm['books.conditionforbook:order']),
        ))
        db.send_create_signal('books', ['ConditionForBook'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'ConditionForBook'
        db.delete_table('books_conditionforbook')
